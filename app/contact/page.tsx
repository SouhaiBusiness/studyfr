...
export default function ContactPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-center mb-8 text-[#1a2630]">Contact Us</h1>
      <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
      Vous avez des questions, des suggestions ou des retours? vous voudriez collaborer ? Notre équipe est là pour vous aidez. Veuillez remplir le 
          ...
          <div className="bg-gray-50 shadow-2xl p-6 rounded-xl h-full transform transition duration-1000 hover:scale-105">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@frenchstudies.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-semibold">Heures du travail</h3>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              ...
              <div className="flex space-x-4">
                <a href="#" className="bg-[#0e2d6d] shadow-lg p-2 rounded-full text-white hover:opacity-90 transition-colors">
